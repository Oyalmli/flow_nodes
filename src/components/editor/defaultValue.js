...
export const introEditor = {
    ...
    blocks: {
      ...
      2: {
        1: {
          ...
          input: { 0: ['1', '1', '0'], 1: ['1', '2', '0'] },
          type: 'redirect',
          output: { 0: [['3', '1', '0']], 1: [['3', '3', '0']] },
        },
        2: {
          name: 'mod',
          source: 'original',
      ...
      3: {
        1: {
          ...
          input: { 0: ['2', '1', '0'], 1: ['2', '2', '0'] },
          type: 'redirect',
          output: { 0: [['4', '1', '0']], 1: [['4', '3', '0']] },
        },
        2: {
          name: 'mod',
          source: 'original',
      ...
      4: {
        1: {
          ...
          input: { 0: ['3', '1', '0'], 1: ['3', '2', '0'] },
          type: 'redirect',
          output: { 0: [['5', '1', '0']], 1: [['5', '3', '0']] },
        },
        3: {
          name: 'printf',
          source: 'original',
  ...
  factory: { variable: [], function: [], object: [] },
  version: '0.1.0',
}
